package com.sm.task.example.api.di

import com.sm.task.example.api.adapters.ApiResponseAdapterFactory
import com.sm.task.example.api.interceptors.GenericInterceptor
import com.sm.task.example.api.interceptors.HeaderFactory
import com.sm.task.example.api.retrofit.ApiService
import com.sm.task.example.api.retrofit.ApiServiceImpl
